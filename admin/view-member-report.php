...
<html lang="en">
<head>
<title>Muscles Architect Admin</title>
<meta charset="UTF-8" />
     ...
     <div class="widget-content">
            <div class="row-fluid">
              ...
              <div class="span8">
                ...
                <table class="table table-bordered table-invoice-full">
                  <tbody>
                    <tr>
                      <td class="msg-invoice" width="55%"> <div class="text-center"><h4>Last Payment Done:  Rs. <?php echo $row['amount']; ?>/-</h4>
            ...
            <div class="row-fluid">
                ...
                <div class="pull-right">
                  ...
                  <img src="../img/stamp.png" width="124px;" alt=""><p class="text-center">Note:AutoGenerated</p> </div>
