...
<html lang="en">
<head>
<title>Muscles Architect Staff A/C</title>
<meta charset="UTF-8" />
...
<!--Header-part-->
<div id="header">
  <h1><a href="dashboard.html">Muscles Architect Staff A/C</a></h1>
</div>
<!--close-Header-part--> 
...
<div id="content">
  <div id="content-header">
    ...
    <h1 class="text-center">Muscles Architect's Equipment List <i class="icon icon-cogs"></i></h1>
  </div>
